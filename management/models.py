...
class SubscriptionPack(models.Model):
    ...
    plantype = models.ForeignKey(
        Plantype, on_delete=models.CASCADE, related_name="packs"
    )
...
class UserSubscription(models.Model):
    ...
    subscription_pack = models.ForeignKey(
        SubscriptionPack, on_delete=models.PROTECT, related_name="user_subscriptions"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class Total_pack(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="total_pack"
    )
...
class SubscriptionTransaction(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="subscription_transactions"
    )
...
class Pricing(models.Model):
    card_creation_price = models.DecimalField(
    ...
    def __str__(self):
        return (
            f"Card: ₹{self.card_creation_price} | Connection: ₹{self.connection_price}"
        )
