...
urlpatterns = [
    ...
    path(
        "pending-transactions/", views.pending_transactions, name="pending-transactions"
    ),
    path("freelancers/", views.freelancers, name="freelancers"),
    path("clients/", views.clients, name="clients"),
    path(
        "freelancer-profile/<str:profile_name>",
        views.freelancer_view_profile,
        name="freelancer_profile",
    ),
    path(
        "client-profile/<str:profile_name>",
        views.client_view_profile,
        name="client_profile",
    ),
    path(
        "freelancer-gigs-list/<str:profile_name>",
        views.freelancer_gig_list,
        name="freelancer_gig_list",
    ),
    ...
    path(
        "freelancer-block/<str:profile_name>",
        views.freelancer_block,
        name="freelancer_block",
    ),
    path(
        "freelancer-unblock/<str:profile_name>",
        views.freelancer_unblock,
        name="freelancer_unblock",
    ),
    path("client-block/<str:profile_name>", views.client_block, name="client_block"),
    path(
        "client-unblock/<str:profile_name>", views.client_unblock, name="client_unblock"
    ),
    ...
    path(
        "category-unblock/<slug:slug>", views.category_unblock, name="category_unblock"
    ),
    path("category-delete/<slug:slug>", views.category_delete, name="category_delete"),
    path(
        "client-wallet-transactions/<str:profile_name>",
        views.client_wallet_transactions,
    ...
    path(
        "client-cards-list/<str:profile_name>",
        views.client_cards_list,
        name="client_cards_list",
    ),
    ...
    path(
        "create-subscriptions/", views.create_subscriptions, name="create_subscriptions"
    ),
    path(
        "edit-subscription/<slug:slug>",
        views.edit_subscription,
        name="edit_subscription",
    ),
    path(
        "disable-subscription/<slug:slug>",
        views.disable_subscription,
        name="disable_subscription",
    ),
    path(
        "enable-subscription/<slug:slug>",
        views.enable_subscription,
        name="enable_subscription",
    ),
    path(
        "delete-subscription/<slug:slug>",
    ...
    path(
        "disable-plantype/<str:name>", views.disable_plantype, name="disable_plantype"
    ),
    path(
        "disable-plantype/<str:name>", views.disable_plantype, name="disable_plantype"
    ),
    ...
    path(
        "freelancer-connections/<int:id>",
        views.freelancer_connections,
        name="freelancer_connections",
    ),
    path(
        "client-connections/<int:id>",
