...
class Connections(models.Model):
    ...
    card = models.ForeignKey(Card, on_delete=models.CASCADE, related_name="connections")

    gig = models.ForeignKey(Gig, on_delete=models.CASCADE, related_name="connections")
