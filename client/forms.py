...
from .models import Card, Location
    ...
    class Meta:
        ...
        widgets = {
            ...
            "profile_photo": forms.FileInput(
                attrs={"class": "hidden", "id": "imageInput", "accept": "image/*"}
            ),
        }
    ...
    def clean_Profile_name(self):
        ...
        if not re.match(pattern, Profile_name):
            ...
            raise forms.ValidationError(
                "Username must contain at least 3 characters, including uppercase, lowercase, and numbers only."
            )
...
class LocationForm(forms.ModelForm):
    ...
    def clean_latitude(self):
        ...
        if not latitude:
            raise forms.ValidationError(
                "Latitude not found. Please fetch location again."
            )
    ...
    def clean_longitude(self):
        ...
        if longitude is None:
            raise forms.ValidationError(
                "Longitude not found. Please fetch location again."
            )
